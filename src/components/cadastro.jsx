      ...
      <div className="w-full h-full flex ml-64 items-center justify-center">
        <div className="w-full max-w-xl my-10 rounded-lg bg-black/70 p-8 shadow-lg">
          ...
          <div className="mb-8">
            ...
            <div className="mb-6">
              <label htmlFor="cpf" className="mb-2 block font-medium text-white">
                CPF:
              </label>
              <input
                type="text"
            ...
            <div className="mb-6">
              <label htmlFor="nome" className="mb-2 block font-medium text-white">
                Nome Completo:
              </label>
              <input
                type="text"
          ...
          <div className="mb-8">
            ...
            <div className="mb-6">
              <label htmlFor="cnpj" className="mb-2 block font-medium text-white">
                CNPJ:
              </label>
              <input
                type="text"
          ...
          <div className="text-center">
            <button
              className="rounded-lg bg-pink-600 px-6 py-3 font-bold text-white hover:bg-green-700 focus:outline-none focus:ring-4 focus:ring-green-900"
              onClick={handleSave}
            >
              Salvar Informações
            </button>
